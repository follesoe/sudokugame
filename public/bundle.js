...
var game = [[8, "?", "?", "?", "?", "?", "?", "?", "?"], ["?", "?", 3, 6, "?", "?", "?", "?", "?"], ["?", 7, "?", "?", 9, "?", 2, "?", "?"], ["?", 5, "?", "?", "?", 7, "?", "?", "?"], ["?", "?", "?", "?", 4, 5, 7, "?", "?"], ["?", "?", "?", 1, "?", "?", "?", 3, "?"], ["?", "?", 1, "?", "?", "?", "?", 6, 8], ["?", "?", 8, 5, "?", "?", "?", 1, "?"], ["?", 9, "?", "?", "?", "?", 4, "?", "?"]];
...
var Sudoku = React.createClass({
  ...
  updateCell: function updateCell(i, j, e) {
    var game = this.state.game;
    var urls = this.state.urls;
    game[i][j] = e.currentTarget.value;
    this.setState({ game: game, urls: urls });
  },
  'new': function _new() {
    var _this = this;
    ...
    xhr({
      ...
      if (err) {
        ...
        _this.setState({ game: res.puzzle, urls: _this.state.urls });
      }
    });
  },
  solve: function solve() {
    ...
    xhr({
      ...
      if (err) {
        ...
        _this2.setState({ game: body, urls: _this2.state.urls });
      }
    });
  },
  updateSolver: function updateSolver(e) {
    this.setState({
  ...
  updateGenerator: function updateGenerator(e) {
    this.setState({
      game: this.state.game,
      urls: {
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        null,
        'Generator url:',
        React.createElement('input', { value: this.state.urls.generator, onChange: this.updateGenerator })
      ),
      React.createElement(
        'label',
        null,
        'Solver url:',
        React.createElement('input', { value: this.state.urls.solver, onChange: this.updateSolver })
      ),
      React.createElement(
        'table',
        null,
        React.createElement(
          'tbody',
          null,
          this.state.game.map(function (row, rowIndex) {
            return React.createElement(
              'tr',
              { key: 'row-' + rowIndex },
              row.map(function (cell, cellIndex) {
                return React.createElement(
                  ...
                  React.createElement(Cell, { number: cell, onChange: _this3.updateCell.bind(null, rowIndex, cellIndex) })
                );
              })
            );
          })
      ...
      React.createElement(
        'button',
        { className: 'btn new', onClick: this['new'] },
        'New Game'
      ),
      React.createElement(
        'button',
        { className: 'btn solve', onClick: this.solve },
        'Solve'
      )
    );
  }
...
ReactDOM.render(React.createElement(Sudoku, null), document.getElementById('game'));

},{"react":158,"react-dom":2,"xhr":159}]},{},[166]);
